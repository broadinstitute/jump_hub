...
| Public `all` profile                                                                  | Convenient when comparing across ORF, CRISPR, and compound perturbations.                                                       | Larger and worse batch correction for users who only need one modality; it may be inconsistent with data generated from modality-specific profiles.                                         |
